...
function Footer() {
  return (
    <footer className="w-full">
      <div className='w-full max-w-[1380px] bg-[#30303D] rounded-tl-[64px] rounded-tr-[64px] mx-auto mt-20 px-4 md:px-6 lg:px-8 py-10 box-border'>
      ...
      <div className='w-full max-w-[1380px] bg-[#FF6687] mx-auto flex flex-col sm:flex-row justify-between items-center py-3 px-4 md:px-6 lg:px-8 box-border'>
